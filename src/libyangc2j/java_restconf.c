...
JNIEXPORT void JNICALL Java_org_conf2_restconf_Service_sendSetDocRoot
  (JNIEnv *env, jobject j, jlong service_hnd_id, jobject j_stream_source) {
    ...
    void *stream_source_hnd_id = yangc2_handle_new(j_g_stream_source, &yangc2j_release_global_ref);
    void *go_stream_source_hnd_id = yangc2_new_driver_resource_source(stream_source_hnd_id, &yangc2j_open_stream,
        &yangc2j_read_stream);
