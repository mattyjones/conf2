...
struct yangc2_browse_value {
    ...
    int int32;
    short bool;
    // reader frees after return (if language doesn't GC it)
    char  *str;
    // TODO: support longer strings and lists
    //int data_len;
    //void *data;
};

typedef void*(*yangc2_browse_enter_impl)(void *selection_handle, char *ident, short *found, void *browse_err);
typedef short (*yangc2_browse_iterate_impl)(void *selection_handle, char *ident, void *keys, short first, void *browse_err);
