...
//export yangc2_testharness_new
func yangc2_testharness_new(browser_hnd_id unsafe.Pointer) unsafe.Pointer {
...
//export yangc2_testharness_test_run
func yangc2_testharness_test_run(harness_hnd_id unsafe.Pointer, c_testname *C.char) (passed C.short) {
	var err error
...
//export yangc2_testharness_report
func yangc2_testharness_report(harness_hnd_id unsafe.Pointer) *C.char {
	harness := harness_from_handle_id(harness_hnd_id)
