...
`)
	expectations := []Token {
		...
		Token{token_space_indent, "  "}, Token{kywd_let, "let"}, Token{token_ident, "q"}, Token{token_equal, "="}, Token{token_ident, "foo"},
			Token{token_open_paren, "("}, Token{token_ident, "bar"}, Token{token_close_paren, ")"}, Token{token_eol, "\n"},
